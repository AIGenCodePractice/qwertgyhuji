...
- [x] xUnit: Interest theories + Loan suites + CalculatorFixture + DecimalPrecisionComparer
- [x] Data-driven tests (DataRow / TestCase / InlineData / MemberData / ClassData)
- [x] Setup/teardown (TestInitialize, SetUp, OneTimeSetUp, fixtures)
- [x] Categories, Ignore, Retry, CancelAfter, Assert.Multiple, Throws demos
...
- [ ] All modules meet numeric thresholds *(documented shortfalls + remediation)*
